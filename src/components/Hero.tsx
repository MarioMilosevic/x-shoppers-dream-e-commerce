...
const Hero = () => {
  ...
  return (
    <section
      ...
      ref={heroRef}
    >
      <div className="mx-auto py-16 w-[90%] sm:max-w-[60%] lg:w-auto sm:mx-0 flex flex-col gap-7 border border-black">
      ...
      <div className="mx-auto w-[90%] sm:max-w-[60%] lg:w-[41%] sm:mx-0 flex flex-col">
