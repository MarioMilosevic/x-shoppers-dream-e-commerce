...
const Slide = ({title, text, img, name, city}:SlideProps) => {

  return (
    <div className="  relative flex flex-col gap-4 py-2 w-[75%] mx-auto">
      ...
      <div className="flex flex-col  ">
        ...
        <div className="flex flex-col pt-12">
          <img src={img} alt={img} className="rounded-full h-20 w-20 object-cover" />
